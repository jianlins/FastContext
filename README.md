...
```
Note: the maven distribution doesn't include the context rule file, you will need to download it [here](https://github.com/jianlins/FastContext/blob/master/conf/context.csv) if needed.
## Quick start
```java
